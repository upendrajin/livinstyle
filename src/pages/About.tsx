      ...
      <div className="pt-32 pb-24 bg-black">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-24">
            <h1 className="font-display text-white text-4xl md:text-5xl font-bold mb-4">About Us</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
            ...
            <div>
              <h2 className="font-display text-2xl md:text-3xl font-bold text-primary mb-4">Our Story</h2>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 ">
            {stats.map((s, i) => (
              <div key={i} className="bg-card/10 rounded-xl p-8 text-center shadow-card">
